...
# for test
data_path=/home/qiyu/jiangmin/xflow/data
sh ./scripts/local.sh 1 1 $root_path/build/test/src/xflow_lr $data_path/small_train $data_path/small_test $model_name $epochs
